jQuery('.mm-prev-btn').hide();
	...
	function submitData() {
		jQuery('.mm-finish-btn').on('click', function() {
            ...
            jQuery('.mm-back-btn').hide();
            jQuery('.mm-survey-results').slideDown();
            event.preventDefault();

            let radio1 = jQuery("input[name=radio1]:checked").val();
            let radio2 = jQuery("input[name=radio2]:checked").val();
            let radio3 = jQuery("input[name=radio3]:checked").val();
            let radio4 = jQuery("input[name=radio4]:checked").val();
